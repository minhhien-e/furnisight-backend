...
import com.furnisight.user.application.account.port.in.usecase.CreateAdminAccountUseCase;
...
class AdminUserGrpcServerMarketingTest {
    ...
    @Mock CreateUserAccountByAdminUseCase createUserAccountByAdminUseCase;
    @Mock CreateAdminAccountUseCase createAdminAccountUseCase;
