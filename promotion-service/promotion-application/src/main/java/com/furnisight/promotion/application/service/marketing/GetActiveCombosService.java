...
import com.furnisight.promotion.application.port.in.usecase.GetActiveCombosUseCase;
...
public class GetActiveCombosService implements GetActiveCombosUseCase {
    ...
    public List<MarketingComboDto> getActiveCombos(GetActiveCombosQuery query) {
