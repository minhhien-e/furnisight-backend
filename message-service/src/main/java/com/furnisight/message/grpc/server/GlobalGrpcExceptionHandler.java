...
import com.furnisight.message.domain.exceptions.DomainException;
import com.furnisight.message.domain.exceptions.AlreadyExistsException;
import com.furnisight.message.domain.exceptions.ErrorCode;
import com.furnisight.message.domain.exceptions.ForbiddenException;
import com.furnisight.message.domain.exceptions.InvalidOperationException;
import com.furnisight.message.domain.exceptions.NotFoundException;
import com.furnisight.message.domain.exceptions.UnauthorizedException;
