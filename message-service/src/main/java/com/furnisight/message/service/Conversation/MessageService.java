...
public class MessageService {
    ...
    public ResponseEntity<AType> searchMessages(
        ...
        Message message = Message.builder()
            ...
            .type(messageReq.getMessageType() != null ? messageReq.getMessageType() : com.furnisight.message.util.enums.MessageType.TEXT)
    ...
    private void moveBackToInProgressWhenCustomerReplies(Conversation conversation) {
        if (com.furnisight.message.util.enums.ConversationStatus.CLOSED.equals(conversation.getStatus())) {
            conversation.setStatus(com.furnisight.message.util.enums.ConversationStatus.OPEN);
            return;
        }

        if (com.furnisight.message.util.enums.ConversationStatus.WAITING_CUSTOMER.equals(conversation.getStatus())
                || com.furnisight.message.util.enums.ConversationStatus.RESOLVED.equals(conversation.getStatus())) {
            conversation.setStatus(com.furnisight.message.util.enums.ConversationStatus.IN_PROGRESS);
        }
    }
    ...
    private void moveToWaitingCustomerAfterAdminReply(Conversation conversation) {
        ...
        conversation.setStatus(com.furnisight.message.util.enums.ConversationStatus.WAITING_CUSTOMER);
    }
    ...
    private List<MessageAttachment> normalizeAttachments(MessageReq messageReq) {
        ...
        return List.of(MessageAttachment.builder()
                ...
                .isImage(com.furnisight.message.util.enums.MessageType.IMAGE.equals(messageReq.getMessageType())
