...
from pipelines.lgnet.utils.conversion import uv2xyz, xyz2uv, depth2xyz, uv2pixel, depth2uv, pixel2uv, xyz2pixel, uv2lonlat
from pipelines.lgnet.utils.visibility_polygon import calc_visible_polygon
...
def connect_corners(uv1: np.ndarray, uv2: np.ndarray, step=0.01, length=None) -> np.ndarray:
    ...
    :param step:
    :param length:
    :return: [[u1, v1], [u2, v2]....] if length!=Noneï¼Œlength of return result = length
    """
