...
class Settings(BaseSettings):
    ...
    LAMA_MODEL_URL: str = _config.get("object_remover", {}).get("lama_model_url", "https://github.com/enesmsahin/simple-lama-inpainting/releases/download/v0.1.0/big-lama.pt")
