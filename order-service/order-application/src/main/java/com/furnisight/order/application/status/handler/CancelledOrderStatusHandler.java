...
@Component
public class CancelledOrderStatusHandler extends AbstractOrderStatusHandler {
    public CancelledOrderStatusHandler(OrderStatusTransitionValidator validator) { super(validator); }
