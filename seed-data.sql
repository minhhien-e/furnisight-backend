...
INSERT INTO categories (id, name, slug, parent_id, path, product_count, image_url, icon_url, created_at, updated_at) VALUES
  ...
  ('c0000000-0000-0000-0000-000000000002', 'Bedroom', 'bedroom', NULL, 'bedroom', 3, 'https://res.cloudinary.com/demo/image/upload/f_auto,q_auto,w_800,h_600,c_fill/sample.jpg', 'bedroom', NOW(), NOW()),
  ...
  ('d0000000-0000-0000-0000-000000000003', 'Bed', 'bed', 'c0000000-0000-0000-0000-000000000002', 'bedroom/bed', 2, 'https://res.cloudinary.com/demo/image/upload/f_auto,q_auto,w_800,h_600,c_fill/cld-sample-2.jpg', 'bed', NOW(), NOW()),
...
INSERT INTO product_images (id, product_id, image_url, position, created_at, updated_at) VALUES
  ...
  (gen_random_uuid(), 'e0000000-0000-0000-0000-000000000004', 'https://res.cloudinary.com/demo/image/upload/f_auto,q_auto,w_1200,h_900,c_fill/sample.jpg', 1, NOW(), NOW()),
  (gen_random_uuid(), 'e0000000-0000-0000-0000-000000000005', 'https://res.cloudinary.com/demo/image/upload/f_auto,q_auto,w_1200,h_900,c_fill/cld-sample-2.jpg', 1, NOW(), NOW()),
