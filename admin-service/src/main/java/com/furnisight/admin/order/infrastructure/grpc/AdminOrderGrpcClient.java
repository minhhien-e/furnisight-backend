package com.furnisight.admin.order.infrastructure.grpc;
...
@Service
public class AdminOrderGrpcClient {
    ...
    public TopSellingProductsResponse getTopSellingProducts(int limit) {
        return adminOrderServiceStub.getTopSellingProducts(GetTopSellingProductsRequest.newBuilder()
                .setLimit(limit)
                .build());
    }
}
